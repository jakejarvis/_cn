...
4. Add `--target` for `registry:page`, `registry:file`, and custom alias installs like `@ui/ai/<file>.tsx`; use `--file-extension` for non-`ts` file or targeted universal items.
